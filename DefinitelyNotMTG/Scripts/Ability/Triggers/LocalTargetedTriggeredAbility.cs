...
public abstract class LocalTargetedTriggeredAbility : TriggeredAbility, ITargets {
    ...
    public int max_targets {
        get { return _max_targets; }
        protected set { _max_targets = value; }
    }
    public int min_targets {
        get { return _min_targets; }
        protected set { _min_targets = value; }
    }
    public ReadOnlyCollection<Zone> targetable_zones {
        get { return new ReadOnlyCollection<Zone>(targetable_zones); }
    }
