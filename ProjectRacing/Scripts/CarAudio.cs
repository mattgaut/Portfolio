...
// Standard assest script moved from standard assest folder in order to acess GameManager
        ...
        private void Update()
        {
            ...
            if (m_StartedSound)
            {
                ...
                else
                {
                    ...
                    m_LowAccel.volume = lowFade*accFade * GameManager.instance.sound_manager.GetSFXVolume();
                    m_LowDecel.volume = lowFade* decFade * GameManager.instance.sound_manager.GetSFXVolume();
                    m_HighAccel.volume = highFade* accFade * GameManager.instance.sound_manager.GetSFXVolume();
                    m_HighDecel.volume = highFade* decFade * GameManager.instance.sound_manager.GetSFXVolume();
